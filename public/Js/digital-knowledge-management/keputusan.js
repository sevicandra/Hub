function preview(params) {
    if (params) {
        $.ajax({
            url:'/digital-knowledge-management/keputusan/'+params,
            type:'GET',
            dataType:'JSON',
...
function updateKeputusan(params) {
    if (params) {
        $.ajax({
            url:'/digital-knowledge-management/keputusan/'+params+'/edit',
            type:'GET',
            dataType:'JSON',
            success: function(result){
                ...
                $('#updateKeputusancontent').append(`
                    <form action="/digital-knowledge-management/keputusan/`+result.id+`" method="POST" enctype="multipart/form-data">
                ...
                `)
                var update = new bootstrap.Modal(document.getElementById('updateKeputusan'), {
                    keyboard: false
                })
                update.show()
            }
    ...
    if (params) {
        $.ajax({
            ...
            success: function(result){
                ...
                `)
                var hapus = new bootstrap.Modal(document.getElementById('hapusKeputusan'), {
                    keyboard: false
                })
                hapus.show()
            }
