...
$('#jenisLelang').change(function () {
    ...
    switch ($(this).val()) {
        case 'OB':
            ...
            $('#downloadPenetapanContainer').append(tanggalLelang+tanggalPengumumanPertama+tanggalPengumumanKedua+waktuAwalPenawaran+waktuAkhirPenawaran+lokasi+button)
            break;
        case 'CB':
            var elementmenit =''
            for (let index = 0; index <= 59; index++) {
            ...
            $('#downloadPenetapanContainer').append(tanggalLelang+tanggalPengumumanPertama+tanggalPengumumanKedua+waktuAkhirPenawaran+lokasi+button)
            break;
    }
});
