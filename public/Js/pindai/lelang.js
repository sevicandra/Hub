...
$('#jenisLelang').change(function () {
    ...
    switch ($(this).val()) {
        case 'OB':
            ...
            var alamat = '<div class="row"><label for="lokasi" class="col-sm-6 col-form-label">Alamat Pemohon</label><div class="col-sm-6"><textarea name="alamat" type="text" rows="4" cols="50" class="form-control" required></textarea></div></div>'
            ...
            var tanggalPengumumanPertama = '<div class="row"><label for="tanggalPengumumanPertama" class="col-sm-6 col-form-label">Tanggal Pengumuman Pertama</label><div class="col-sm-6"><input name="tanggalPengumumanPertama" class="form-control" type="date" required></div></div>'
            var tanggalPengumumanKedua = '<div class="row"><label for="tanggalPengumumanKedua" class="col-sm-6 col-form-label">Tanggal Pengumuman Kedua</label><div class="col-sm-6"><input name="tanggalPengumumanKedua" class="form-control" type="date"></div></div>'
            ...
            var button = '<div style="margin-top:10px"><button value="penetapanLelangOpen" type="submit" class="btn btn-primary" name="action">Cetak Penetapan</button> <button value="HPKB" type="submit" class="btn btn-primary" name="action">ND Penyampaian</button></div>'
            $('#downloadPenetapanContainer').append(tanggalLelang+tanggalPengumumanPertama+tanggalPengumumanKedua+waktuAwalPenawaran+waktuAkhirPenawaran+alamat+lokasi+button)
            break;
        case 'CB':
            var elementmenit =''
            for (let index = 0; index <= 59; index++) {
            ...
            var alamat = '<div class="row"><label for="lokasi" class="col-sm-6 col-form-label">Alamat Pemohon</label><div class="col-sm-6"><textarea name="alamat" type="text" rows="4" cols="50" class="form-control" required></textarea></div></div>'
            var lokasi = '<div class="row"><label for="lokasi" class="col-sm-6 col-form-label">Lokasi Lelang</label><div class="col-sm-6"><textarea name="lokasi" type="text" rows="4" cols="50" class="form-control" required>Kantor Pelayanan Kekayaan Negara dan Lelang Ternate Jalan Yos Sudarso No. 333, Kota Ternate</textarea></div></div>'
            var button = '<div style="margin-top:10px"><button value="penetapanLelangClosed" type="submit" class="btn btn-primary" name="action">Cetak Penetapan</button> <button value="HPKB" type="submit" class="btn btn-primary" name="action">ND Penyampaian</button></div>'
            $('#downloadPenetapanContainer').append(tanggalLelang+tanggalPengumumanPertama+tanggalPengumumanKedua+waktuAkhirPenawaran+alamat+lokasi+button)
            break;
    }
});
