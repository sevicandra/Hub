...
class FileStorageController extends Controller
{
    ...
    public function index()
    {
        return view('digitalKnowledgeManagement.index',[
            ...
            'fileStorage'=>'',
            'suratKeputusanData'=>keputusan::orderBy('created_at', 'desc')->get(),
            ...
            'presentasiData'=>presentasi::orderBy('created_at', 'desc')->get(),
            'presentasiThisMonth'=>presentasi::whereMonth('created_at', date('m')),
            'presentasiLastMonth'=>presentasi::whereMonth('created_at', date('m')-1),
            'laporanPelaksanaanTugasData'=>laporanPelaksanaanTugas::orderBy('created_at', 'desc')->get(),
            ...
            'notulaData'=>notula::orderBy('created_at', 'desc')->get(),
