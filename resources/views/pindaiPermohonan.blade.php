...
<div class="container-fluid" style="padding: 30px 37px 9px 37px">
    <div class="container-fluid" style="border-radius: 10px; background-color:aliceblue">
        ...
        <div class="row" style="height:80vh; padding: 0; background-color:aliceblue">
            <div class="container-fluid">
                <div class="row" style="height: 74vh; border-radius:10px;">
                    <div class="table table-light" style="padding: 0; height: 70vh; background-color:aliceblue">
                        <table class="table table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/permohonan/{{$item->id}}" style="color: green"><i class="bi bi-eye-fill"></i></a>
                                    <a href="" style="color: red"><i class="bi bi-trash-fill"></i></a>
                                    <button type="button" class="btn" id='send' name='send' value="{{$item->id}}"><i class="bi bi-send-fill"></i></button>
                                    <a href="" style="color: blue"><i class="bi bi-file-earmark-arrow-down-fill"></i></a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                            @endforeach    
                ...
                <div class="row " style="margin: 10px 0 0 0 ">
                    <div class=" d-flex justify-content-end" style="padding:0">
                        <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#permohonan">Tambah Permohonan</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div>
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div>
                                <button type="submit" class="btn btn-primary" id='permohonan_id' value=''>Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
