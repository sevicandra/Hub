                        ...
                        <form class="row" action="@if ($data->target->first()) /updateTarget @else /inputTarget @endif" method="POST" style="height: 100%">
                            ...
                            <div style="height: 90%; overflow-y:hidden">
                                ...
                                <div class="row" style="margin-top:10px; height: 80%">
                                    ...
                                    <div class="col-sm-8"><input name="target[]" required type="number" min='0.01' step=0.01 class="form-control Q1" disabled @if ($data->target->where('periode', 'Q1')->first())value="{{$data->target->where('periode', 'Q1')->first()->target}}"@endif></div>
                                    <div class="col-sm-4">
                                        <p class="content">Raw</p>
                                    </div>
                                    <div class="col-sm-8"><input name="raw[]" type="number" min='0.01' step=0.01 class="form-control Q1" disabled @if ($data->target->where('periode', 'Q1')->first())value="{{$data->target->where('periode', 'Q1')->first()->raw}}"@endif></div>
                                    <div class="col-sm-12" style="height: 5%">
                                    ...
                                    <div class="col-sm-8" style="height: 10%"><input name="target[]" required type="number" min='0.01' step=0.01 class="form-control Q2" disabled @if ($data->target->where('periode', 'Q2')->first())value="{{$data->target->where('periode', 'Q2')->first()->target}}"@endif></div>
                                    <div class="col-sm-4" style="height: 10%">
                                        <p class="content">Raw</p>
                                    </div>
                                    <div class="col-sm-8" style="height: 10%"><input name="raw[]" type="number" min='0.01' step=0.01 class="form-control Q2" disabled @if ($data->target->where('periode', 'Q2')->first())value="{{$data->target->where('periode', 'Q2')->first()->raw}}"@endif></div>
                                    <div class="col-sm-12" style="height: 5%">
                                    ...
                                    <div class="col-sm-8" style="height: 10%"><input name="target[]" required type="number" min='0.01' step=0.01 class="form-control Q3" disabled @if ($data->target->where('periode', 'Q3')->first())value="{{$data->target->where('periode', 'Q3')->first()->target}}"@endif></div>
                                    <div class="col-sm-4" style="height: 10%">
                                        <p class="content">Raw</p>
                                    </div>
                                    <div class="col-sm-8" style="height: 10%"><input name="raw[]" type="number" min='0.01' step=0.01 class="form-control Q3" disabled @if ($data->target->where('periode', 'Q3')->first())value="{{$data->target->where('periode', 'Q3')->first()->raw}}"@endif></div>
                                    <div class="col-sm-12" style="height: 5%">
                                    ...
                                    <div class="col-sm-8" style="height: 10%"><input name="target[]" required type="number" min='0.01' step=0.01 class="form-control Q4" disabled @if ($data->target->where('periode', 'Q4')->first())value="{{$data->target->where('periode', 'Q4')->first()->target}}"@endif></div>
                                    <div class="col-sm-4" style="height: 10%">
                                        <p class="content">Raw</p>
                                    </div>
                                    <div class="col-sm-8" style="height: 10%"><input name="raw[]" type="number" min='0.01' step=0.01 class="form-control Q4" disabled @if ($data->target->where('periode', 'Q4')->first())value="{{$data->target->where('periode', 'Q4')->first()->raw}}"@endif></div>
                                </div>
                            </div>
                            <div>
