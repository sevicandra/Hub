...
<div class="container-fluid" style="padding: 30px 37px 9px 37px; height:100%">
    <div class="container-fluid" style="border-radius: 10px; background-color:darkgrey; height:100%">
        <div class="row" style="padding-bottom: 10px; height:38px">
            ...
            <div class="col-sm-2" >
                <a href="/filestorage/presentasi">
                    <button class="btn translate-middle-y" style="width: 100%; @if (isset($presentasi)) background-color: rgb(13, 110, 253); color:white @else background-color: white @endif">Presentasi</button>
                </a>
            </div>
        </div>
