                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="margin:auto; margin-left:0; padding:0">
                                <div style="background: #4D59CA; border-radius: 0px 10px 10px 0px; height:34px;">
                                    <p align="center">#Tiket
                                </div>
                            </div>
                        </div>
                    </form>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td style="max-width: 100px">
                                            ...
                                            @endif
                                            @if (!isset($item->pemberitahuanPenilaian))
                                                <button onClick="dowloadusulanSKST('{{ $item->id }}')" type="button"
                                                    class="btn d-inline" data-bs-toggle="modal"
                                                    data-bs-target="#dowloadusulanSKST"><i
                                                        class="bi bi-download"></i></button>
                                            @endif
                                            @if (!isset($item->pemberitahuanPenilaian))
                                                <button onClick="pemberitahuan('{{ $item->id }}')" type="button"
                                                    class="btn d-inline" data-bs-toggle="modal"
                                                    data-bs-target="#pemberitahuanPenilaian"><i
                                            ...
                                            @if (!isset($item->pemberitahuanPenilaian->penyampaianLaporan))
                                                @if ($item->permohonan->barang->count() === $item->permohonan->barang->where('laporan_penilaian_id', '!=', null)->count())
                                                    <button
                                                        onClick="penyampaianLaporan('{{ $item->pemberitahuanPenilaian->id }}')"
                                                        class="btn d-inline" data-bs-toggle="modal"
                                                        data-bs-target="#kirimLaporan"><i
                                            ...
                                            @if (isset($item->pemberitahuanPenilaian->penyampaianLaporan))
                                                <form action="/cetak" method="POST" class="d-inline">
                                                    @csrf
                                                    <input type="text" value="{{ $item->pemberitahuanPenilaian->id }}"
                                                        required hidden name="pemberitahuan_penilaian_id">
                                                    <button type="submit" class="btn" name="action"
                                                        value="kajiulang"><i class="bi bi-cloud-download"></i></button>
                                                </form>
                                            @endif
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <form action="cetak" method="POST">
                            ...
                            <button id="tambahTim" class="btn" type="button"><i
                                    class="bi bi-plus-square"></i></i></button>
                            <div class="row">
